...
}; // expected-note 51 {{'S_NonMovable' is a non-memmove()able type because it
   // inherits from a non-memmove()able type 'NonMovable'}}
...
struct WS_NonMovable {
  S_NonMovable
      m; // expected-note 34 {{'WS_NonMovable' is a non-memmove()able type
         // because member 'm' is a non-memmove()able type 'S_NonMovable'}}
};
struct WS_Movable {
  S_Movable m;
};
...
}; // expected-note 17 {{'SW_NonMovable' is a non-memmove()able type because it
   // inherits from a non-memmove()able type 'W_NonMovable'}}
struct SW_Movable : W_Movable {};

struct SWS_NonMovable : WS_NonMovable {
}; // expected-note 17 {{'SWS_NonMovable' is a non-memmove()able type because it
   // inherits from a non-memmove()able type 'WS_NonMovable'}}
...
template <class T> struct Template_Ref {
  T *m;
};
...
void bad1() {
  ...
  NeedyTemplate1<SW_NonMovable> a5; // expected-note-re {{instantiation of
                                    // 'NeedyTemplate1<{{.*}}>' requested here}}
  NeedyTemplate1<SWS_NonMovable>
      a6; // expected-note-re {{instantiation of 'NeedyTemplate1<{{.*}}>'
          // requested here}}

  NeedyTemplate1<Template_Inline<NonMovable>>
      b1; // expected-note-re {{instantiation of 'NeedyTemplate1<{{.*}}>'
          // requested here}}
  NeedyTemplate1<Template_Inline<S_NonMovable>>
      b2; // expected-note-re {{instantiation of 'NeedyTemplate1<{{.*}}>'
          // requested here}}
  NeedyTemplate1<Template_Inline<W_NonMovable>>
      b3; // expected-note-re {{instantiation of 'NeedyTemplate1<{{.*}}>'
          // requested here}}
  NeedyTemplate1<Template_Inline<WS_NonMovable>>
      b4; // expected-note-re {{instantiation of 'NeedyTemplate1<{{.*}}>'
          // requested here}}
  NeedyTemplate1<Template_Inline<SW_NonMovable>>
      b5; // expected-note-re {{instantiation of 'NeedyTemplate1<{{.*}}>'
          // requested here}}
  ...
  NeedyTemplate1<Template_NonMovable<SWS_NonMovable>>
      c6; // expected-note-re {{instantiation of 'NeedyTemplate1<{{.*}}>'
          // requested here}}
  NeedyTemplate1<Template_NonMovable<Movable>>
      c7; // expected-note-re {{instantiation of 'NeedyTemplate1<{{.*}}>'
          // requested here}}
  NeedyTemplate1<Template_NonMovable<S_Movable>>
      c8; // expected-note-re {{instantiation of 'NeedyTemplate1<{{.*}}>'
          // requested here}}
  NeedyTemplate1<Template_NonMovable<W_Movable>>
      c9; // expected-note-re {{instantiation of 'NeedyTemplate1<{{.*}}>'
          // requested here}}
...
}; // expected-note-re 26 {{instantiation of 'NeedyTemplate2<{{.*}}>' requested
   // here}}
...
}; // expected-note-re 26 {{instantiation of 'NeedyTemplate4<{{.*}}>' requested
   // here}}
template <class T> struct WS_NeedyTemplate4 {
...
}; // expected-note 8 {{'S_SpecializedNonMovable' is a non-memmove()able type
   // because it inherits from a non-memmove()able type
...
void specialization() {
  ...
  */
  NeedyTemplate1<Template_Inline<SpecializedNonMovable>>
      b1; // expected-note-re {{instantiation of
          // 'NeedyTemplate1<Template_Inline<SpecializedNonMovable>{{ ?}}>'
          // requested here}}
...
class MOZ_NEEDS_MEMMOVABLE_MEMBERS NeedsMemMovableMembers {
  ...
  SW_Movable swm1;
  SW_NonMovable
      swm2; // expected-error {{class 'NeedsMemMovableMembers' cannot have
            // non-memmovable member 'swm2' of type 'SW_NonMovable'}}
  WS_Movable wsm1;
  WS_NonMovable
      wsm2; // expected-error {{class 'NeedsMemMovableMembers' cannot have
            // non-memmovable member 'wsm2' of type 'WS_NonMovable'}}
  SWS_Movable swsm1;
  SWS_NonMovable
      swsm2; // expected-error {{class 'NeedsMemMovableMembers' cannot have
             // non-memmovable member 'swsm2' of type 'SWS_NonMovable'}}
};
