...
class BadClass
    : public nsISupports, // expected-error {{Cycle-collected class 'BadClass'
                          // inherits from 'SupportsWeakPtr' but its cycle
                          // collection Unlink does not call 'DetachWeakPtr'()}}
...
NS_IMPL_CYCLE_COLLECTION_UNLINK_BEGIN(
    BadClass) // expected-note {{Unlink defined here; add
...
class BadWeakRefClass
    : public nsSupportsWeakReference { // expected-error {{Cycle-collected class
                                       // 'BadWeakRefClass' inherits from
                                       // 'nsSupportsWeakReference' but its
                                       // cycle collection Unlink does not call
                                       // 'ClearWeakReferences'()}}
public:
  NS_DECL_CYCLE_COLLECTING_ISUPPORTS
...
NS_IMPL_CYCLE_COLLECTION_UNLINK_BEGIN(
    BadWeakRefClass) // expected-note {{Unlink defined here; add
                     // 'NS_IMPL_CYCLE_COLLECTION_UNLINK_WEAK_REFERENCE'}}
NS_IMPL_CYCLE_COLLECTION_UNLINK_END
NS_IMPL_CYCLE_COLLECTION_TRAVERSE_BEGIN(BadWeakRefClass)
NS_IMPL_CYCLE_COLLECTION_TRAVERSE_END

// --- Good: nsSupportsWeakReference with
// NS_IMPL_CYCLE_COLLECTION_UNLINK_WEAK_REFERENCE ---
