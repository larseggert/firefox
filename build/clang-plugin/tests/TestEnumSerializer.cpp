...
template <>
struct ParamTraits<WithCount> // expected-warning
                              // {{ContiguousEnumSerializerInclusive includes
                              // sentinel value 'OP_COUNT' as valid; use
                              // ContiguousEnumSerializer with an exclusive
                              // upper bound instead}}
...
template <>
struct ParamTraits<
    WithMax> // expected-warning {{ContiguousEnumSerializerInclusive includes
             // sentinel value 'MAX' as valid; use ContiguousEnumSerializer with
             // an exclusive upper bound instead}}
...
template <>
struct ParamTraits<WithInvalid> // expected-warning
                                // {{ContiguousEnumSerializerInclusive includes
                                // sentinel value 'Invalid' as valid; use
                                // ContiguousEnumSerializer with an exclusive
                                // upper bound instead}}
...
template <>
struct ParamTraits<SkippedFirst> // expected-warning {{ContiguousEnumSerializer
                                 // min value 'Second' does not match the first
                                 // enumerator 'First' (value 0); the range
                                 // excludes valid enum values}}
...
template <>
struct ParamTraits<Rotation> // expected-error {{ContiguousEnumSerializer used
                             // with non-contiguous enum; range accepts 271
                             // values but only 4 enumerators exist (267 invalid
                             // values accepted)}}
...
template <>
struct ParamTraits<Duplicate> // expected-error {{ContiguousEnumSerializer used
                              // with non-contiguous enum; range accepts 4
                              // values but only 3 enumerators exist (1 invalid
                              // values accepted)}}
...
template <>
struct ParamTraits<Flags> // expected-error {{ContiguousEnumSerializer used with
                          // non-contiguous enum; range accepts 9 values but
                          // only 5 enumerators exist (4 invalid values
                          // accepted)}}
...
template <>
struct ParamTraits<
    ComboIssue> // expected-warning {{ContiguousEnumSerializerInclusive includes
                // sentinel value 'OP_COUNT' as valid; use
                // ContiguousEnumSerializer with an exclusive upper bound
                // instead}} expected-warning
                // {{ContiguousEnumSerializerInclusive min value 'Over' does not
                // match the first enumerator 'Clear' (value 0); the range
                // excludes valid enum values}}
...
template <>
struct ParamTraits<
    StorageAccess> // expected-error {{ContiguousEnumSerializerInclusive used
                   // with non-contiguous enum; range accepts 6 values but only
                   // 5 enumerators exist (1 invalid values accepted)}}
...
template <>
struct ParamTraits<
    MissedHigh> // expected-warning {{ContiguousEnumSerializerInclusive upper
                // bound does not match the last enumerator 'D' (value 3); the
                // range may exclude valid enum values}}
...
template <>
struct ParamTraits<
    MissedHighExcl> // expected-warning {{ContiguousEnumSerializer upper bound
                    // does not match the last enumerator 'Count' (value 4); the
                    // range may exclude valid enum values}}
