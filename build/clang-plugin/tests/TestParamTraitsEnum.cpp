...
template <>
struct ParamTraits<ClassEnum> // expected-error {{Custom ParamTraits
                              // implementation for an enum type}} expected-note
                              // {{Please use a helper class for example
...
template <>
struct ParamTraits<TypedClassEnum> // expected-error {{Custom ParamTraits
                                   // implementation for an enum type}}
                                   // expected-note {{Please use a helper class
                                   // for example ContiguousEnumSerializer}}
{};

template <>
struct ParamTraits<enum RawEnum> // expected-error {{Custom ParamTraits
                                 // implementation for an enum type}}
                                 // expected-note {{Please use a helper class
                                 // for example ContiguousEnumSerializer}}
{};
...
template <>
struct ParamTraits<BadEnum> // expected-error {{Custom ParamTraits
                            // implementation for an enum type}} expected-note
                            // {{Please use a helper class for example
                            // ContiguousEnumSerializer}}
{};
...
template <>
struct ParamTraits<NestedDefLevel2> // expected-error {{Custom ParamTraits
                                    // implementation for an enum type}}
                                    // expected-note {{Please use a helper class
                                    // for example ContiguousEnumSerializer}}
{};
