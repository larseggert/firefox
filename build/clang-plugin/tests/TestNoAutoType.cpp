...
void f() {
  {
    ...
    const auto &brc =
        a; // expected-error {{Cannot use auto to declare a variable of type
           // 'const ExplicitType &'}} expected-note {{Please write out this
           // type explicitly}}
...

  {
    ...
    const auto &brc =
        a; // expected-error {{Cannot use auto to declare a variable of type
           // 'const ExplicitTypeTemplate<int> &'}} expected-note {{Please write
           // out this type explicitly}}
    auto *bp = &a; // expected-error {{Cannot use auto to declare a variable of
                   // type 'ExplicitTypeTemplate<int> *'}} expected-note
                   // {{Please write out this type explicitly}}
    const auto *bpc =
        &a; // expected-error {{Cannot use auto to declare a variable of type
            // 'const ExplicitTypeTemplate<int> *'}} expected-note {{Please
            // write out this type explicitly}}
  }
...
ExplicitType A;
MOZ_RUNINIT auto B = A; // expected-error {{Cannot use auto to declare a
                        // variable of type 'ExplicitType'}} expected-note
                        // {{Please write out this type explicitly}}
