 ...
 * @property {string} role - The button's role attribute, used in shadow DOM and therefore not as an attribute on moz-button.
 ...
 * @property {string} roleAttribute - Internal, map role attribute to the role JS property.
