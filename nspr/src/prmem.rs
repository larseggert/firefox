...
#[no_mangle]
pub extern "C" fn PR_Malloc(size: PRUint32) -> *mut ffi::c_void {
    unsafe { libc::malloc(size as libc::size_t) }
}

// NSPR_API(void *) PR_Calloc(PRUint32 nelem, PRUint32 elsize);
#[no_mangle]
pub extern "C" fn PR_Calloc(nelem: PRUint32, elsize: PRUint32) -> *mut ffi::c_void {
    unsafe { libc::calloc(nelem as libc::size_t, elsize as libc::size_t) }
}

// NSPR_API(void *) PR_Realloc(void *ptr, PRUint32 size);
#[no_mangle]
pub extern "C" fn PR_Realloc(ptr: *mut ffi::c_void, size: PRUint32) -> *mut ffi::c_void {
    unsafe { libc::realloc(ptr, size as libc::size_t) }
}

// NSPR_API(void) PR_Free(void *ptr);
#[no_mangle]
pub extern "C" fn PR_Free(ptr: *mut ffi::c_void) {
