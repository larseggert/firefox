...
use crate::prtypes::{PRInt32, PRUint32, PRUword};

#[repr(C)]
pub struct PLArena {
    next: *mut PLArena,         /* next arena for this lifetime */
    base: PRUword,           /* aligned base address, follows this header */
    limit: PRUword,          /* one beyond last byte in arena */
    avail: PRUword,         /* points to next available byte */
}
//
// #ifdef PL_ARENAMETER
...
pub struct PLArenaPool {
    first: PLArena,          /* first arena in pool list */
    current: *mut PLArena,       /* arena from which to allocate space */
...
#[no_mangle]
pub extern "C" fn PL_ARENA_ALLOCATE(
    p: *mut *mut ffi::c_void,
...
#[no_mangle]
pub extern "C" fn PL_ARENA_MARK(pool: *mut PLArenaPool) -> *mut ffi::c_void {
    unimplemented!()
}
...
#[no_mangle]
pub extern "C" fn PL_ARENA_RELEASE(pool: *mut PLArenaPool, mark: *mut ffi::c_void) {
    unimplemented!()
}
...
**/
#[no_mangle]
pub extern "C" fn PL_InitArenaPool(
    pool: *mut PLArenaPool,
...
#[no_mangle]
pub extern "C" fn PL_ArenaFinish() {
    unimplemented!()
}
...
#[no_mangle]
pub extern "C" fn PL_FreeArenaPool(pool: *mut PLArenaPool) {
    unimplemented!()
}
...
**/
#[no_mangle]
pub extern "C" fn PL_FinishArenaPool(pool: *mut PLArenaPool) {
    unimplemented!()
}
...
#[no_mangle]
pub extern "C" fn PL_ClearArenaPool(pool: *mut PLArenaPool, pattern: PRInt32) {
    unimplemented!()
}
