...
use crate::{
    prio::{PRFileMap, PRFileMapProtect},
    prtypes::{PRIntn, PRSize, PRStatus},
};

pub const PR_FILEMAP_STRING_BUFSIZE: PRIntn = 128;
...
#[no_mangle]
pub extern "C" fn PR_OpenAnonFileMap(
    dirName: *const ffi::c_char,
    size: PRSize,
...
#[no_mangle]
pub extern "C" fn PR_ExportFileMapAsString(
    fm: *mut PRFileMap,
    bufSize: PRSize,
    buf: *mut ffi::c_char,
) -> PRStatus {
...
#[no_mangle]
pub extern "C" fn PR_ImportFileMapFromString(fmstring: *const ffi::c_char) -> *mut PRFileMap {
    unimplemented!()
}
