...
use crate::prtypes::{PRIntn, PRUint32};
 ...
 *  2) complete the API on platforms lacking common functions (e.g., strcase*), and
 *  3) to implement some obvious "closure" functions that I've seen people hacking around in our
 *     code.
 *
...
#[no_mangle]
pub extern "C" fn PL_strlen(str: *const ffi::c_char) -> PRUint32 {
    #[expect(
        clippy::cast_possible_truncation,
        reason = "libc::strlen returns size_t"
    )]
    unsafe {
        libc::strlen(str) as PRUint32
    }
}
...
#[no_mangle]
pub extern "C" fn PL_strncpyz(
    dest: *mut ffi::c_char,
    src: *const ffi::c_char,
    max: PRUint32,
) -> *mut ffi::c_char {
    unsafe { libc::strncpy(dest, src, max as usize) } // FIXME: strlcpy
}
...
#[no_mangle]
pub extern "C" fn PL_strdup(s: *const ffi::c_char) -> *mut ffi::c_char {
...
// PL_strfree(char *s);
#[no_mangle]
pub extern "C" fn PL_strfree(s: *mut ffi::c_void) {
    unsafe { libc::free(s) }
}
...
#[no_mangle]
pub extern "C" fn PL_strndup(s: *const ffi::c_char, max: PRUint32) -> *mut ffi::c_char {
    unsafe { libc::strndup(s, max as usize) }
}
...
#[no_mangle]
pub extern "C" fn PL_strcatn(
    dst: *mut ffi::c_char,
    max: PRUint32,
    src: *const ffi::c_char,
) -> *mut ffi::c_char {
    unsafe { libc::strncat(dst, src, max as usize) }
}
 ...
 */
#[no_mangle]
pub extern "C" fn PL_strcmp(a: *const ffi::c_char, b: *const ffi::c_char) -> PRIntn {
 ...
 */
#[no_mangle]
pub extern "C" fn PL_strcasecmp(a: *const ffi::c_char, b: *const ffi::c_char) -> PRIntn {
 ...
 */
#[no_mangle]
pub extern "C" fn PL_strncasecmp(
    a: *const ffi::c_char,
    b: *const ffi::c_char,
    max: PRUint32,
) -> PRIntn {
    unsafe { libc::strncasecmp(a, b, max as libc::size_t) }
}
// PR_EXTERN(PRIntn)
...
#[no_mangle]
pub extern "C" fn PL_strpbrk(s: *const ffi::c_char, list: *const ffi::c_char) -> *mut ffi::c_char {
    unsafe { libc::strpbrk(s, list) }
}
...
#[no_mangle]
pub extern "C" fn PL_strstr(
    big: *const ffi::c_char,
    little: *const ffi::c_char,
) -> *mut ffi::c_char {
    unsafe { libc::strstr(big, little) }
}
 ...
 */
#[no_mangle]
pub extern "C" fn PL_strcasestr(
    big: *const ffi::c_char,
    little: *const ffi::c_char,
) -> *mut ffi::c_char {
    unsafe { libc::strcasestr(big, little) }
}
// PR_EXTERN(char *)
...
#[no_mangle]
pub extern "C" fn PL_strtok_r(
    s1: *mut ffi::c_char,
    s2: *const ffi::c_char,
    lasts: *mut *mut ffi::c_char,
) -> *mut ffi::c_char {
    unsafe { libc::strtok_r(s1, s2, lasts) }
}
