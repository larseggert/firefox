...
#[no_mangle]
#[allow(clippy::missing_safety_doc)] pub unsafe extern "C" fn uri_template_addref(builder: &UriTemplateWrapper) {
    builder.refcnt.inc();
}

#[no_mangle]
#[allow(clippy::missing_safety_doc)] pub unsafe extern "C" fn uri_template_release(builder: &UriTemplateWrapper) {
